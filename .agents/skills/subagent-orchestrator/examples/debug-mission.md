...
User: "My Vercel deploy is failing. Build error: Cannot find module
...
> Repair missions should almost never exceed 10% sprint quota. If a repair is
> growing complex, stop — decompose it as a new full mission instead.
