...
## App Shape
- `frontend/` is a standalone Vue/Vite workspace inside the parent repo; run frontend commands here, but edit root `.github/`, release config, and repo-wide instructions from the parent directory.
